...
import com.example.kmc.PSLogin.PSGroundingUserDetails;
...
public class myadapterPS4 extends RecyclerView.Adapter<myadapterPS4.myviewholder>
{
    ArrayList<Individual> datalist;

    public myadapterPS4(ArrayList<Individual> datalist) {
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(holder.t1.getContext(), PSGroundingUserDetails.class);
