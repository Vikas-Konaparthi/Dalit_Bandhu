...
public class SPUserDetailsAmountDBToBen extends AppCompatActivity {
...
//        }
    ...
    public void approve(View view) {
        String approved="yes";
        status=getIntent().getStringExtra("uPSRequestedAmount").toString()+" approved by Special Officer waiting for SO Approval";
                ...
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    db.collection("individuals")
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(SPUserDetailsAmountDBToBen.this, "Error occured", Toast.LENGTH_SHORT).show();
                        }
                    });

                }else{

                    Toast.makeText(SPUserDetailsAmountDBToBen.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
