...
public class CollectorGroundingUserDetails extends AppCompatActivity {
...
//    public TextView getSpApprovedAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collector_grounding_user_details);
...
//        getSpApprovedAmount=(TextView) findViewById(R.id.spApprovedAmount);
            ...
            groundImageButton=(Button)findViewById(R.id.groundingImage);
